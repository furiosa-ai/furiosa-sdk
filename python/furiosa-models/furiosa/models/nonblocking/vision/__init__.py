...
async def load(name, *args, **kwargs) -> Optional[Model]:
    ...
    return await furiosa.registry.load(
        uri="https://github.com/furiosa-ai/furiosa-artifacts:v0.0.4", name=name, *args, **kwargs
    )


for name in synchronous(registry.list)("https://github.com/furiosa-ai/furiosa-artifacts:v0.0.4"):
