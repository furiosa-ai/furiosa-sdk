...
class ModelInferRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"id",b"id",u"inputs",b"inputs",u"model_name",b"model_name",u"model_version",b"model_version",u"outputs",b"outputs",u"parameters",b"parameters",u"raw_input_contents",b"raw_input_contents"]) -> None: ...
...
class ModelInferResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"id",b"id",u"model_name",b"model_name",u"model_version",b"model_version",u"outputs",b"outputs",u"parameters",b"parameters",u"raw_output_contents",b"raw_output_contents"]) -> None: ...
