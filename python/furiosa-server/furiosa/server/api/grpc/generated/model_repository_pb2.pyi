...
class RepositoryIndexRequest(google.protobuf.message.Message):
    ...
    def ClearField(
        ...
        field_name: typing_extensions.Literal[
            u"ready", b"ready", u"repository_name", b"repository_name"
        ],
    ) -> None: ...
...
class RepositoryIndexResponse(google.protobuf.message.Message):
    ...
    class ModelIndex(google.protobuf.message.Message):
        ...
        def ClearField(
            self,
            field_name: typing_extensions.Literal[
                u"name", b"name", u"reason", b"reason", u"state", b"state", u"version", b"version"
            ],
        ) -> None: ...
...
class RepositoryModelLoadRequest(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            u"model_name", b"model_name", u"repository_name", b"repository_name"
        ],
    ) -> None: ...
