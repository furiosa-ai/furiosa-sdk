...
from furiosa.common.config import load_furiosa_config
from furiosa.common.consts import FURIOSA_SDK_VERSION_VALUE
...
class CompilerClient:  # pylint: disable=too-few-public-methods
    ...
    def submit_compile(
        ...
        source,
        x_request_id=None,
        x_furiosa_ai_sdk_version=FURIOSA_SDK_VERSION_VALUE,
        compiler_config='{}',
        target_npu_spec='{}',
    ) -> CompileTask:
        ...
        response = self.api.create_task(
            x_furiosa_ai_sdk_version=x_furiosa_ai_sdk_version,
