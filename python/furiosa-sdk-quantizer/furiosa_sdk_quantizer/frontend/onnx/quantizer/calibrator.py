...
class ONNXCalibrator:
    ...
    def calibrate(self, dataset: List[Dict[str, np.ndarray]]) -> Dict[str, Tuple[float, float]]:
    ...
    def _attach_minmax_observer(self, node_output_name):
        ...
        reduce_min_node = make_node(
            "ReduceMin", [node_output_name], [reduce_min_name], reduce_min_name, keepdims=0
        )
        ...
        reduce_max_node = make_node(
            "ReduceMax", [node_output_name], [reduce_max_name], reduce_max_name, keepdims=0
        )
